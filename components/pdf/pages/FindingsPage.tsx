          ...
          <View key={finding.id || index} style={{ marginBottom: 16 }}>
            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" }} wrap={false}>
              <View style={{ maxWidth: "78%" }}>
                <Text style={{ fontSize: 9, color: theme.accent, letterSpacing: 1.2, marginBottom: 6 }}>Finding {String(index + 1).padStart(2, "0")}</Text>
            ...
            <View style={{ flexDirection: "row", gap: 18, marginTop: 8, marginBottom: 8 }} wrap={false}>
            ...
            <View style={{ marginTop: 9, borderTopWidth: 1, borderTopColor: theme.border }} />
          </View>
        );
      })}
    </ReportPage>
