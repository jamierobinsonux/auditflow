    ...
    <main className="min-h-screen bg-[#F1F5F9] p-10">
      <div className="mx-auto max-w-2xl rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-5">
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 space-y-4">
            ...
            {images.map((imageItem, index) => (
              <div key={index} className="rounded-xl bg-white p-4 space-y-3">
                ...
                <textarea
                  className="min-h-20 w-full rounded-xl border border-slate-200 p-3"
          ...
          <button className="w-full rounded-xl bg-violet-600 px-4 py-3 font-semibold text-white hover:bg-violet-700">
            Save Finding
          </button>
        </form>
      </div>
